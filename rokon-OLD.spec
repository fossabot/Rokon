...
# Only Fedora Linux and Mageia and distributions based off of them seem to support go macros. It's relatively new to RPM.
%if 0%{?fedora} || 0%{?mageia}
%global use_go_macros 1
%endif
...
%if 0%{?opensuse_bs}
Source0:         Rokon.tar.xz
%else
Source0:         https://nightly.link/BrycensRanch/Rokon/workflows/publish/master/rokon-source.zip
%endif
